...
\[
	\| (f_i)_{i \in I} \| \ :=\  \Bigl\| \textstyle \sum_i f_i f_i^* \Bigr\|^{1/2},
\]
...
\begin{rem}
	...
	\[
		\cat{C}\longrightarrow \Ban, \qquad B\ \longmapsto\ {\bigoplus_i}^K \cat{C}(A_i, B) \ := \ \left\{\, (f_i : A_i \to B)_{i\in I} \biggm\vert \sum_{i,j} K_{ij} f_i f_j^* < \infty \,\right\},
	\]
