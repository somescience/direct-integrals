...
It follows from the following generalization of the
...
\end{equation*}
We interpret the sum as before either in terms of a supremum over the norm of finite partial sums, or as converging in the double dual $\cat{C}(B,B)^{**}$.
